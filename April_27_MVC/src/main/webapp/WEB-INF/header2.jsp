	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top mx-4 py-3">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
		  <ul class="navbar-nav" style="font-size: 16pt;">
	         ...
	         <c:if test="${sessionScope.loginuser != null and sessionScope.loginuser.userid == 'admin'}">  <%-- admin으로 로그인 했으면  --%>
	         ...
	         <c:if test="${sessionScope.loginuser != null and sessionScope.loginuser.userid ne 'admin'}">  <%-- 일반사용자로 로그인 했으면  --%>
				 <li class="nav-item dropdown">
	  ...
	  <div class="row">
		 <div class="col-md-3" id="sideinfo">
			...
			<div style="height: 200px; text-align: left; padding: 20px;">
				2. 로그인/Tree/View(민동현 컴퓨터)
				<%@ include file="/WEB-INF/login/login.jsp" %>
				
			</div>
			
			<%-- == 쇼핑몰 카테고리 목록 만을 보여주는 부분이다. == --%>
