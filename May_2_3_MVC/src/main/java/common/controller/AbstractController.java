...
public abstract class AbstractController implements InterCommand {
	...
	*/
	...
	public void goBackURL(HttpServletRequest request) {    // goBackURL 은 부모클래스에서 가져옴 
		
		//System.out.println(MyUtil.getCurrentURL(request));   // MyUtil 에서 가져온다.
		// 결과 :  /shop/prodView.up?pnum=65
