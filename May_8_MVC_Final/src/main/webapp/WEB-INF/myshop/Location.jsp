...
<style>
 ...
 --%> 
 <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ea842ccdea31da80c160df947fff5f0a"></script> 
 ...
 <script type="text/javascript">
  $(document).ready(function(){
   ...
   // 지도 타입 컨트롤을 지도에 표시함.  // 확대나 축소 하는 컨트롤러 
